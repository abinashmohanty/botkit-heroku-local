    ...
    bot.startRTM(function(err) {
      ...
      bot.startPrivateConversation({user: config.createdBy},function(err,convo) {
        if (err) {
          ...
          convo.say('Thank you so much for adding me.');
...
/* ==========================================================
Greet new users when they join our defaut slack channel aka #general
========================================================== */
...
controller.hears(['community promotion'], ['direct_message','direct_mention','mention'],function(bot,message) {
